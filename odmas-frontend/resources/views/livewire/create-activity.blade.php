<div class="container-fluid p-0">
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-between">
            <h3 class="text-capitalize"> New activity </h3>
                ...
                <form wire:submit="store">
                    <div class="row mb-2">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('activity_name') is-invalid @enderror"
                                wire:model="activity_name" value="{{ old('activity_name') }}" id="activity_name">
                            @error('activity_name')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                                wire:model="end_date" value="{{ old('end_date') }}" id="end_date">
                            @error('end_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            ...
                            <select wire:model="is_recurring"
                                class="form-select @error('is_recurring') is-invalid @enderror"
                                aria-label="Default select choice">
                                <option selected>Select ocurrence</option>
                        ...
                        <div class="col-6">
                            <label for="recurring_frequency" class="form-label text-capitalize">Frequency of
                                recurrence</label>
                            <select wire:model="recurring_frequency"
                                class="form-select @error('recurring_frequency') is-invalid @enderror"
                                aria-label="Default select choice">
                    ...
                    <div class="mb-2">
                        ...
                        <select wire:model="has_report" class="form-select  @error('has_report') is-invalid @enderror"
                            aria-label="Default select choice">
