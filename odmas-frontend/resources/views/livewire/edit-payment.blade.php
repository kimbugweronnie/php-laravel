@push('styles')
    <style>
        .custom-tab table, .custom-tab th, .custom-tab td {
...
<div class="container-fluid p-0">
    <div class="row">
        ...
        <div class="col-lg-12 d-flex justify-content-between">
            <h4 class="text-capitalize fw-bold">{{ $paymentReq['title'] }}</h4>
    ...
    <div class="row mt-3">
                ...
                <table class="table table-bordered">
                        ...
                        <tr>
                            <th colspan="7">
                                <div class="fs-4 text-uppercase fw-bold text-center pb-4">
                                    <div><img src="{{ asset('img/full-logo.png') }}" width="120" alt=" payment image"></div>
                                    ...
                                    <div>{{ $paymentReq['title'] }} form</div>
                                </div>
                                <div>
                                    <div class="row mb-3">
                                        <div class="col-6 fs-4">Requisitioning Officer: {{ $paymentReq['related_document_request']['added_by']['first_name'] }} {{ $paymentReq['related_document_request']['added_by']['last_name'] }} </div>
                                        <div class="col-6 fs-4">Source of Funds:</div>
                                    </div>
                                    <div class="fs-4 mb-3">Purpose:</div>    
                                </div>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="fw-bold text-capitalize" colspan="2">Amount({{ $paymentReq['currency_id']['currency_symbol'] }})</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"></td>
                            <td class="fw-bold" colspan="2">{{ $paymentReq['total'] }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-uppercase px-5"></td>
                        ...
                        <tr>
                            ...
                            <td class="text-uppercase">{{ $paymentReq['related_document_request']['related_project_document']['related_project']['project_name'] }}</td>
                            <td class="text-uppercase">CONTRACTUAL</td>
                            <td></td>
                            <td class="text-uppercase">{{ $paymentReq['budget_category'] }}</td>
                            <td class="text-uppercase">{{ $paymentReq['related_activity'] ? $paymentReq['related_activity']['activity_name'] : null }}</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="12">
                        ...
                        <tbody>
                            @foreach($attachedDocuments as $attachedDocument)
                                <tr class="">
                                    ...
                                    <td> {{ $paymentReq['related_document_request']['added_by']['first_name']  }} {{ $paymentReq['related_document_request']['added_by']['last_name']  }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        @if(Session::has('userDetails') && Session::get('userDetails')['id'] != $paymentReq['related_document_request']['added_by']['id'])
                    ...
                    <div class="border bg-white rounded-3 shadow p-4">
                        @foreach($paymentReq['approval_steps'] as $approver)
                            <div class="row mt-2">
                                ...
                                <div class="col-12">
                                    @if ($approver['next_step'] && !$approver['status'] && $approver['next_step'] && 
