<div class="container-fluid p-0">
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-between">
            <h3 class="text-capitalize">Payment request </h3>
    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            ...
            <div class="border rounded-3 bg-white shadow py-4 px-5">
                <form  wire:submit="paymentRequest">
                    <div class="row mb-2">
                        <div class="col-6">
                            <label for="payment_date" class="form-label">Date</label>
                            <input wire:model="payment_date" type="date" class="form-control @error('payment_date') is-invalid @enderror" value="{{ old('payment_date') }}">
                            @error('payment_date')
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <label for="budget_category" class="form-label text-capitalize">Budget category</label>
                            <input wire:model="budget_category" type="text" class="form-control @error('budget_category') is-invalid @enderror" value="{{ old('budget_category') }}" >
                            @error('budget_category')
                                <span class="invalid-feedback" role="alert">
                                    <strong>The budget category is required.</strong>
                                </span>
                            @enderror
                        </div>
                        <div class="col-6">
                            <label for="cost_center" class="form-label text-capitalize">Cost center</label>
                            <select wire:model="cost_center" aria-label="Default select" class="form-select @error('cost_center') is-invalid @enderror">
                                <option value="">Select a cost center</option>
                                @forelse($cost_centers as $cost_center)
                                    <option value="{{ $cost_center['id'] }}">{{ $cost_center['cost_center_name'] }}</option>
                                @empty
                                    <option>No cost centers</option>
                                @endforelse
                            </select>
                             @error('cost_center')
                                <span class="invalid-feedback" role="alert">
                    ...
                    <h4 class="text-capitalize fw-bold">Item list (Required)</h4>
                    <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-flex justify-content-end">
                                <label for="total_amount" class="form-label text-capitalize">Final Total</label>
                            </div>
                    ...
                    <div class="col-12 mt-4 d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary px-3 {{ $total_amount ? '' : 'disabled' }}">Submit</button>
                    </div>
                </form>
            </div>
        </div>
