...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-lg-12 d-flex mb-3 justify-content-between">
            <h4 class="text-capitalize fw-bold">{{ $procurementReq['title'] }}</h4>
    ...
    <div class="row">
            ...
            <div class="border bg-white rounded-3 shadow px-4 py-3">
                <table class="table table-bordered">
                        ...
                        <tr>
                            <th colspan="9">
                                <div class="fs-4 text-uppercase fw-bold text-center pb-4">
                                    <div><img src="{{ asset('img/full-logo.png') }}" width="120" alt=" procurement image"></div>
                                    <div>Uganda episcopal conference - Uganda catholic secretariat</div> 
                                    ...
                                    <div>{{ $procurementReq['title'] }} form</div>
                                </div>
                            </th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-bold text-uppercase" colspan="9">Subject of procurement:</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-capitalize">Estimated Total Cost ({{$procurementReq['currency_id']['currency_symbol']}})</td>
                        </tr>
                        @php
                            $counter = 1;
                        @endphp
                        ...
                        <tr>
                            <td></td>
                            <td class="text-uppercase">{{ $procurementReq['related_document_request']['related_project_document']['related_project']['project_name'] }}</td>
                            <td></td>
                        ...
                        <tr>
                            <td colspan="12">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-4 fs-4">
                                        <span class="fw-bold text-capitalize">Date:</span> {{ Carbon\Carbon::parse($approver['date_performed'])->format('d/m/Y')}}
                                    </div>
                                </div>
                                <div class="row mt-4">
                        ...
                        <tbody>
                            @foreach($attachedDocuments as $attachedDocument)
                                <tr class="">
                                    ...
                                    <td> {{ $procurementReq['related_document_request']['added_by']['first_name']  }} {{ $procurementReq['related_document_request']['added_by']['last_name']  }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        @if(Session::has('userDetails') && Session::get('userDetails')['id'] != $procurementReq['related_document_request']['added_by']['id'])
