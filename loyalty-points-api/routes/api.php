...
Route::group(['middleware' => ['auth:sanctum','role:merchant']], function () {
    ...
    Route::get('/v2/points/{id}/points',[MerchantController::class,'getPoints']);
    ...
    Route::put('/v2/merchants/{id}',[MerchantController::class,'update']); 
    Route::delete('/v2/merchants/{id}',[MerchantController::class,'destroy']);
    
    Route::post('/v2/programs',[ProgramController::class,'store']);
   
    Route::put('/v2/programs/{id}',[ProgramController::class,'update']); 
    Route::delete('/v2/programs/{id}',[ProgramController::class,'destroy']); 
});
Route::group(['middleware' => ['auth:sanctum','role:customer']], function () {
    ...
    Route::put('/v2/subscriptions/update/{id}/{userid}',[SubscriptionController::class,'update']); 
    Route::put('/v2/subscription/update/{id}/{user_id}/unsubscribe',[SubscriptionController::class,'unsubscribe']); 
    Route::delete('/v2/subscription/{id}',[SubscriptionController::class,'destroy']);
...
Route::group(['middleware' => ['auth:sanctum','role:customer|admin']], function () {
    ...
    Route::put('/v2/customers/{id}',[CustomerController::class,'update']); 
    Route::delete('/v2/customers/{id}',[CustomerController::class,'destroy']); 
});
